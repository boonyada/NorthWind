...
qWork("create table $tb (orderid int(4),customerid char(40),employeeid int(10))");
qWork("insert into $tb values('1006','Mo','66666')");
qWork("insert into $tb values('1007','Tax','77777')");
qWork("insert into $tb values('1008','Pit','88888')");
if((int)phpversion() >= 7) $connect->close(); else mysql_close($connect);
echo '<a href="s0index3.php">back</a>';
