...
qWork("create table $tb (orderid int(4),productid int(10),unitprice int(10))");
qWork("insert into $tb values('1006','100','10')");
qWork("insert into $tb values('1007','101','20')");
qWork("insert into $tb values('1008','102','30')");
if((int)phpversion() >= 7) $connect->close(); else mysql_close($connect);
echo '<a href="s0index5.php">back</a>';
